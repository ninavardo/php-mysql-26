...
if (isset($_GET['drop'])) {
    $id = (int) $_GET['drop'];
    $delete_query = "UPDATE ingredients SET deleted_at = NOW() WHERE id = $id";
...
if (isset($_POST['insert_button'])) {
    ...
    $insert_query = "INSERT INTO ingredients (name) VALUES ('$name')";
...
if (isset($_POST['update_button']) && isset($_POST['id'])) {
    ...
    $update_query = "UPDATE ingredients SET name = '$name', updated_at = '$date' WHERE id = $id";
    mysqli_query($connect, $update_query);
    header("Location: ingredients.php");
    exit;
}

$select_query = "SELECT * FROM ingredients WHERE deleted_at IS NULL";
...
if (isset($_GET['id']) && !isset($_POST['update_button'])) {
    $id = (int) $_GET['id'];
    $edit_query = "SELECT * FROM ingredients WHERE id = $id";
